...
class PlazaSDK::Test::PrimitiveModelTest < Minitest::Test
  A = PlazaSDK::Internal::Type::ArrayOf[-> { Integer }]
  H = PlazaSDK::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < PlazaSDK::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      PlazaSDK::Internal::Type::Unknown,
      PlazaSDK::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => PlazaSDK::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [PlazaSDK::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [PlazaSDK::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [PlazaSDK::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = PlazaSDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        PlazaSDK::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [PlazaSDK::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [PlazaSDK::Internal::Type::Boolean, true] => true,
      [PlazaSDK::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => PlazaSDK::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        PlazaSDK::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = PlazaSDK::Internal::Type::Converter.new_coerce_state
      PlazaSDK::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        PlazaSDK::Internal::Type::Converter.dump(target, input, state: state)
...
class PlazaSDK::Test::EnumModelTest < Minitest::Test
  class E0
    include PlazaSDK::Internal::Type::Enum
...
class PlazaSDK::Test::CollectionModelTest < Minitest::Test
  A1 = PlazaSDK::Internal::Type::ArrayOf[-> { Integer }]
  H1 = PlazaSDK::Internal::Type::HashOf[Integer]

  A2 = PlazaSDK::Internal::Type::ArrayOf[H1]
  H2 = PlazaSDK::Internal::Type::HashOf[-> { A1 }]

  A3 = PlazaSDK::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = PlazaSDK::Internal::Type::HashOf[Integer, nil?: true]
...
class PlazaSDK::Test::BaseModelTest < Minitest::Test
  class M1 < PlazaSDK::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < PlazaSDK::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < PlazaSDK::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, PlazaSDK::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = PlazaSDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = PlazaSDK::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(PlazaSDK::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue PlazaSDK::Errors::ConversionError => e
...
class PlazaSDK::Test::UnionTest < Minitest::Test
  class U0
    include PlazaSDK::Internal::Type::Union
  ...
  class M2 < PlazaSDK::Internal::Type::BaseModel
  ...
  class M4 < PlazaSDK::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, PlazaSDK::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < PlazaSDK::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, PlazaSDK::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class PlazaSDK::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include PlazaSDK::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [PlazaSDK::Internal::Type::Unknown, PlazaSDK::Internal::Type::Unknown] => true,
      [PlazaSDK::Internal::Type::Boolean, PlazaSDK::Internal::Type::Boolean] => true,
      [PlazaSDK::Internal::Type::Unknown, PlazaSDK::Internal::Type::Boolean] => false,
...
class PlazaSDK::Test::MetaInfoTest < Minitest::Test
  A1 = PlazaSDK::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = PlazaSDK::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
