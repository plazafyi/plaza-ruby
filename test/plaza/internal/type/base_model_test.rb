...
class Plaza::Test::PrimitiveModelTest < Minitest::Test
  A = Plaza::Internal::Type::ArrayOf[-> { Integer }]
  H = Plaza::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Plaza::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Plaza::Internal::Type::Unknown,
      Plaza::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Plaza::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Plaza::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Plaza::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Plaza::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Plaza::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Plaza::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Plaza::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Plaza::Internal::Type::Boolean, true] => true,
      [Plaza::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Plaza::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Plaza::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Plaza::Internal::Type::Converter.new_coerce_state
      Plaza::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Plaza::Internal::Type::Converter.dump(target, input, state: state)
...
class Plaza::Test::EnumModelTest < Minitest::Test
  class E0
    include Plaza::Internal::Type::Enum
...
class Plaza::Test::CollectionModelTest < Minitest::Test
  A1 = Plaza::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Plaza::Internal::Type::HashOf[Integer]

  A2 = Plaza::Internal::Type::ArrayOf[H1]
  H2 = Plaza::Internal::Type::HashOf[-> { A1 }]

  A3 = Plaza::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Plaza::Internal::Type::HashOf[Integer, nil?: true]
...
class Plaza::Test::BaseModelTest < Minitest::Test
  class M1 < Plaza::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Plaza::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Plaza::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Plaza::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Plaza::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Plaza::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Plaza::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Plaza::Errors::ConversionError => e
...
class Plaza::Test::UnionTest < Minitest::Test
  class U0
    include Plaza::Internal::Type::Union
  ...
  class M2 < Plaza::Internal::Type::BaseModel
  ...
  class M4 < Plaza::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Plaza::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Plaza::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Plaza::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Plaza::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Plaza::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Plaza::Internal::Type::Unknown, Plaza::Internal::Type::Unknown] => true,
      [Plaza::Internal::Type::Boolean, Plaza::Internal::Type::Boolean] => true,
      [Plaza::Internal::Type::Unknown, Plaza::Internal::Type::Boolean] => false,
...
class Plaza::Test::MetaInfoTest < Minitest::Test
  A1 = Plaza::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Plaza::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
