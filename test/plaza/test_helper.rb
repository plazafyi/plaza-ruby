...
class Plaza::Test::SingletonClient < Plaza::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Plaza::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Plaza::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @plaza = Plaza::Test::SingletonClient.instance
  end
