    ...
    module Util
      ...
      class << self
        ...
        sig do
          params(
            data:
              T.any(Plaza::Internal::AnyHash, T::Array[T.anything], T.anything),
            pick:
              T.nilable(
                T.any(
                  Symbol,
      ...
      class << self
        ...
        # @api private
        sig do
          params(parsed: Plaza::Internal::Util::ParsedUri).returns(URI::Generic)
        end
        ...
        sig do
          params(
            lhs: Plaza::Internal::Util::ParsedUri,
            rhs: Plaza::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        # @api private
        sig do
          params(query: Plaza::Internal::AnyHash).returns(
        ...
        sig do
          params(
            collection: Plaza::Internal::AnyHash,
            key: String,
            element: T.anything
          ).void
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[Plaza::Internal::Util::ServerSentEvent]
          )
        end
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(Plaza::Internal::Util::SorbetRuntimeSupport, T.anything)
            ).returns(T.anything)
          end
