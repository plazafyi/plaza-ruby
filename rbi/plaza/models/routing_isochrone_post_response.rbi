  ...
  module Models
    class RoutingIsochronePostResponse < Plaza::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Plaza::Models::RoutingIsochronePostResponse,
      ...
      sig do
        returns(
          T.nilable(Plaza::Models::RoutingIsochronePostResponse::Properties)
        )
      end
      ...
      sig do
        params(
          properties:
            T.nilable(
              Plaza::Models::RoutingIsochronePostResponse::Properties::OrHash
            )
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(
            Plaza::Models::RoutingIsochronePostResponse::Type::TaggedSymbol
          )
        )
      end
      attr_reader :type
      ...
      sig do
        params(
          type: Plaza::Models::RoutingIsochronePostResponse::Type::OrSymbol
        ).void
      end
      attr_writer :type
        ...
        override.returns(
          {
            ...
            properties:
              T.nilable(
                Plaza::Models::RoutingIsochronePostResponse::Properties
              ),
            type:
              Plaza::Models::RoutingIsochronePostResponse::Type::TaggedSymbol
          }
      ...
      class Properties < Plaza::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Plaza::Models::RoutingIsochronePostResponse::Properties::Mode::TaggedSymbol
            )
          )
        end
        attr_reader :mode
        ...
        sig do
          params(
            mode:
              Plaza::Models::RoutingIsochronePostResponse::Properties::Mode::OrSymbol
          ).void
        end
        attr_writer :mode
        ...
        module Mode
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Plaza::Models::RoutingIsochronePostResponse::Properties::Mode
              )
            end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Plaza::Models::RoutingIsochronePostResponse::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
