...
module Plaza
  module Models
    class RouteRequest < Plaza::Internal::Type::BaseModel
      ...
      required :destination, -> { Plaza::PointGeometry }
      ...
      #
      #   @return [Plaza::Models::PointGeometry]
      required :origin, -> { Plaza::PointGeometry }
      ...
      #
      #   @return [Array<Plaza::Models::PointGeometry>, nil]
      optional :waypoints, -> { Plaza::Internal::Type::ArrayOf[Plaza::PointGeometry] }, nil?: true
      ...
      #
      #   @param destination [Plaza::Models::PointGeometry] GeoJSON Point geometry per RFC 7946. Coordinates use [longitude, latitude] order
      #
      #   @param origin [Plaza::Models::PointGeometry] GeoJSON Point geometry per RFC 7946. Coordinates use [longitude, latitude] order
      #
      ...
      #
      #   @param waypoints [Array<Plaza::Models::PointGeometry>, nil] Intermediate waypoints to visit in order (maximum 25)
