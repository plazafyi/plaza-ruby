      ...
      class PooledNetRequester
        ...
        class << self
          ...
          def calibrate_socket_timeout(conn, deadline)
            timeout = deadline - Plaza::Internal::Util.monotonic_secs
          ...
          def build_request(request, &blk)
            ...
            in String
              ...
              req.body_stream = Plaza::Internal::Util::ReadIOAdapter.new(body, &blk)
            in StringIO
        ...
        private def with_pool(url, deadline:, &blk)
          origin = Plaza::Internal::Util.uri_origin(url)
          timeout = deadline - Plaza::Internal::Util.monotonic_secs
          pool =
        ...
        def execute(request)
          ...
          enum = Enumerator.new do |y|
            ...
            raise Plaza::Errors::APITimeoutError.new(url: url, request: req)
          rescue StandardError
            raise Plaza::Errors::APIConnectionError.new(url: url, request: req)
          end
          # rubocop:enable Metrics/BlockLength

          _, response = enum.next
          body = Plaza::Internal::Util.fused_enum(enum, external: true) do
            finished = true
            loop { enum.next }
          end
