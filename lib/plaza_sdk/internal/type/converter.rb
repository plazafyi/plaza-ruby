    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { PlazaSDK::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { PlazaSDK::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            PlazaSDK::FilePart.new(value)
          in PlazaSDK::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in PlazaSDK::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [PlazaSDK::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: PlazaSDK::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in PlazaSDK::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in PlazaSDK::Internal::Type::Converter
              ...
              PlazaSDK::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(PlazaSDK::Internal::Type::Converter, T::Class[T.anything]) }
        end
