...
module PlazaSDK
  module Models
    ...
    class GeocodeForwardParams < PlazaSDK::Internal::Type::BaseModel
      ...
      # @!method initialize(q:, bbox: nil, country_code: nil, lang: nil, lat: nil, layer: nil, limit: nil, lng: nil, request_options: {})
